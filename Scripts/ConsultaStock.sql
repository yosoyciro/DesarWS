...
BEGIN
	...
	CASE V.TIPOTRANSMISION WHEN 'M' THEN 'MANUAL' WHEN 'A' THEN 'AUTOMATICA' ELSE 'NO ESPECIFICADO' END TIPOCAJA, CA.DESCRIPCION CATEGORIA, dbo.PrecioArticulo(S.ARTICULOSID, V.CATEGORIASID, V.TIPOTRANSMISION) PRECIOVENTA
